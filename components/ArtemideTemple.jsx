...
const ArtemideTemple = ({ className = "" }) => {
  ...
  useEffect(() => {
    const setupViewer = async () => {
      ...
      // Initialize WebGI
      const { ViewerApp, addBasePlugins, FileTransferPlugin } = await import(
        "webgi"
      );
      ...
      try {
        ...
        await viewer.load(
          "https://cdn.glitch.me/292c8a7c-b689-4140-8a6b-562b9e35543b/Scene2.glb?v=1727653870933"
        );
    ...
    <section className={[styles.climaticInner, className].join(" ")}>
      ...
      <div className={styles.comeLavoriamoParent}>
        ...
        <div className={styles.themeSelection}>
          ...
          <div
            className={`${styles.warmbt} ${
              mode === "warm" ? styles.active : ""
            }`}
