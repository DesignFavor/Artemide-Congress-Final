    ...
    const setupViewer = async () => {
      ...
      try {
        ...
        if (!viewer.getPlugin(InteractionPromptPlugin)) {
          const interactionPrompt = await viewer.addPlugin(
            InteractionPromptPlugin
          );
        ...
        // Load the GLB model
        await viewer.load(
          "https://cdn.glitch.me/292c8a7c-b689-4140-8a6b-562b9e35543b/artemis.glb?v=1727655430435"
        );
      ...
      <div className={`${styles.overlay} ${!showOverlay && styles.fadeOut}`}>
        <div className={styles.overlayContent}>
          ...
          <h3 className={styles.explain}>
            Rotate and explore experience by dragging your mouse!
          </h3>
          <button
