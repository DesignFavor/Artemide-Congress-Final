...
const Page8 = () => {
  ...
  async function onSubmit() {
    ...
    <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
      ...
      <div style="margin-bottom: 20px;">
        ...
        <ul style="list-style: none; padding: 0;">
          ...
          <li>👤 <strong style="font-size: 18px;">Last Name:</strong> <span style="font-size: 18px; font-weight: bold;">${fullName}</span></li>
    ...
    // Ensure banquetingOptionSelected is a string
    const banquetingOption = typeof banquetingOptionSelected === 'string' && banquetingOptionSelected.length <= 2000
      ? banquetingOptionSelected
      : null;
    ...
    await databases.createDocument(
      ...
      "unique()",
      {
        applicant: applicantName, // Only applicant field
        ...
        banquetingOptionSelected: banquetingOption, // Validated banqueting option
        selectedBarOption: selectedBarOption || null,
